...
link_info = [[     0,      0,       0,       0,       0,   0],  # "theta" rotation in z
             [0.2625,      0,      a2,      a4,      a5,  a7],  # "d" translation in z
             [3.14/2,      0, -3.14/2, -3.14/2, -3.14/2,   0],  # "alfa" rotation in x
             [0     , 0.6+a1,      a3,       0,      a6,   0],  # "a" translation in x
...
base_3d_obj = [
    Model3D('https://cdn.jsdelivr.net/gh/viniciusmgn/uaibot_content@master/contents/ABBCRB15000/base_link.stl',
            scale,
            np.identity(4),
...
link_3d_obj.append(
    [Model3D('https://cdn.jsdelivr.net/gh/viniciusmgn/uaibot_content@master/contents/ABBCRB15000/link_2.stl',
             scale,
             Utils.trn([-0.6-a1,0,0]) @ Utils.rotx(-3.14/2) @ Utils.roty(3.14/2),
             MeshMaterial(metalness=0.7, clearcoat=1, roughness=0.5, normal_scale=[0.5, 0.5], color="#606060",
                          opacity=1))]
)
...
link_3d_obj.append(
    [Model3D('https://cdn.jsdelivr.net/gh/viniciusmgn/uaibot_content@master/contents/ABBCRB15000/link_3.stl',
             scale,
             Utils.trn([-0.005-a3,0, -a2]) @ Utils.roty(-3.14/2),
             MeshMaterial(metalness=0.7, clearcoat=1, roughness=0.5, normal_scale=[0.5, 0.5], color="#606060",
                          opacity=1))]
)
...
link_3d_obj.append(
    [Model3D('https://cdn.jsdelivr.net/gh/viniciusmgn/uaibot_content@master/contents/ABBCRB15000/link_4.stl',
             scale,
             Utils.trn([0.005,a4,0]) @ Utils.roty(-3.14/2) @ Utils.rotz(-3.14/2),
...
link_3d_obj.append(
    [Model3D('https://cdn.jsdelivr.net/gh/viniciusmgn/uaibot_content@master/contents/ABBCRB15000/link_5.stl',
             scale,
             Utils.trn([-0.045-(a6-0.05),0.095+(a5-0.1),0.005]) @ Utils.rotz(3.14/2) @ Utils.roty(-3.14/2) @ Utils.rotx(3.14/2),
...
link_3d_obj.append(
    [Model3D('https://cdn.jsdelivr.net/gh/viniciusmgn/uaibot_content@master/contents/ABBCRB15000/link_6.stl',
             scale,
            Utils.trn([0.005,0.000,0.1072-a7]) @ Utils.roty(-3.14/2),
