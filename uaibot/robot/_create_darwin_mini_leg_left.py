...
def _create_darwin_mini_leg_left(htm, name, color, opacity):
    ...
    link_3d_obj.append(
        [Model3D(
            'https://cdn.jsdelivr.net/gh/viniciusmgn/uaibot_content@master/contents/DarwinMini/mini_cr_calf.obj',
            0.004,
        ...
        [Model3D(
            ...
            Model3D(
                ...
                MeshMaterial(metalness=0.5, clearcoat=0, roughness=0.5, normal_scale=[0.5, 0.5], color=color,
                             opacity=opacity, side="DoubleSide")),
            Model3D(
                'https://cdn.jsdelivr.net/gh/viniciusmgn/uaibot_content@master/contents/DarwinMini/foot.obj',
                0.004,
                Utils.inv_htm(Q01 * Q02 * Q03 * Q04) * Utils.trn([0.34, 0.19, -0.31]) * Utils.rotz(np.pi),
                MeshMaterial(metalness=0.5, clearcoat=0, roughness=0.5, normal_scale=[0.5, 0.5], color=color,
                             opacity=opacity, side="DoubleSide")),
            Model3D(
                'https://cdn.jsdelivr.net/gh/viniciusmgn/uaibot_content@master/contents/DarwinMini/sole.obj',
                0.004,
                Utils.inv_htm(Q01 * Q02 * Q03 * Q04) * Utils.trn([0.34, 0.19, -0.31]) * Utils.rotz(np.pi),
                MeshMaterial(metalness=0.5, clearcoat=0, roughness=0.5, normal_scale=[0.5, 0.5], color=color,
                             opacity=opacity, side="DoubleSide"))
